...
// {
    ...
    public class PrescriptionController : ControllerBase
    {
        ...
        {
            //Build the File Path.
            string path = Directory.GetCurrentDirectory()+ Path.DirectorySeparatorChar +"Files"+ Path.DirectorySeparatorChar +"Prescriptions" + Path.DirectorySeparatorChar + fileName;
        ...
        [HttpGet("DownloadFile/Simple")]
        public FileResult DownloadFileSimple(string fileName)
        {
            //Build the File Path.
            string path = "./Files/Prescriptions/" + fileName;
        ...
        [HttpGet("DownloadFile/PathCombine")]
        public FileResult DownloadFilePathCombine(string fileName)
        {
            //Build the File Path.
